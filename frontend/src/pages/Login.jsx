    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            <div className="flex justify-center mb-4">
                {/* <img src="" alt="collect"/> */}
                <h2 className="text-3xl font-extrabold tracking-tighter text-black inline-flex items-center justify-center gap-2">C<span className="text-red-500"><RiCircleFill /></span></h2>
            </div>
            <h2 className="text-2xl text-center mb-6">Login to see more</h2>
            ...
            <div className="mt-6 text-center">
                ...
                <div className="mt-4 text-center text-sm">
                    <span>
                        Not on Collect yet? <Link to="/register" className="font-medium hover:underline">Register</Link>
                    </span>
                </div>
            </div>
        </div>
